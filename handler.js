...
`.trim(), data.jid)
            ...
            if ((usedPrefix = (match[0] || '')[0])) {
                ...
                if (plugin.level > _user.level) {
                    this.reply(m.chat, `.*┏━━━━━━━━━━━━━━━━⬣
*┇❗┇ ↯المستوي الخاص بك لا يسمح بي استخدام هذا الامر
❐⊹━━━━━『𝙆𝘼𝙄』━━━━━⊹❐
*┇🥷┇ ↯ يتطلب⇇❪${plugin.level}❫
❐⊹━━━━━『𝙆𝘼𝙄』━━━━━⊹❐
...
let msg = {
        premium: '*┏━━━━━━━━━━━━━━━━⬣*\n`│⁞⩺ لـازم تـكـون مـسـتـخـدم بـريـمـيـوم` 🪄⪀\n*┗━━━━━━━━━━━━━━━━⬣*',
        group: '*┏━━━━━━━━━━━━━━━━⬣*\n`│⁞⩺ الامر دا للاستخدام في المجموعات فقط` 🎃⪀\n*┗━━━━━━━━━━━━━━━━⬣*',       
        private: '*┏━━━━━━━━━━━━━━━━⬣*\n`│⁞⩺ الامر دا للاستخدام في الخاص فقط` 🧚⪀\n*┗━━━━━━━━━━━━━━━━⬣*',       
        botAdmin: '*┏━━━━━━━━━━━━━━━━⬣*\n`│⁞⩺ لـازم يـكـون الـبـوت ادمـن لـاسـتـخـدام الـامر` 🩸⪀\n*┗━━━━━━━━━━━━━━━━⬣*',
        admin: '*┏━━━━━━━━━━━━━━━━⬣*\n`│⁞⩺ الامر دا بتاع المشرفين بس ياض` 🥱\n*┗━━━━━━━━━━━━━━━━⬣*',
        restrict: 'لم يتم تشغيل التقييد لهذه الدردشة',
        adminonly: '',
        premiumonly: ``,
        groups: '',
        gconly: `*┏━━━━━━━━━━━━━━━━⬣*\n│⁞⩺ انضم البوت عشان تستخدم براحتك 🥂⪀\n*┗━━━━━━━━━━━━━━━━⬣*`,
        game: 'الميزة *اللعبة* لم يتم تشغيلها لهذه الدردشة',
        rpg: 'الميزة *Rpg* لم يتم تشغيلها لهذه الدردشة',
        rowner: '*┏━━━━━━━━━━━━━━━━⬣*\n`│⁞⩺ الـامـر دا لـ مـشـرفـيـن الـبـوت فـقـط` 🥂⪀\n*┗━━━━━━━━━━━━━━━━⬣*',
        owner: '*┏━━━━━━━━━━━━━━━━⬣*\n`│⁞⩺ الــامــر دا خــاص بــالــمـطــور` 🥂⪀\n*┗━━━━━━━━━━━━━━━━⬣*',
        mods: '*┏━━━━━━━━━━━━━━━━⬣*\n`│⁞⩺ الامر دا بتاع المشرفين بس ياض` 🥱\n*┗━━━━━━━━━━━━━━━━⬣*'
        }[type]
  ...
  if (msg) return conn.sendMessage(m.chat, {
    ...
    let daftar = {
  unreg: `┏━━━━━━━━━━━━━━━━⬣*\n│⁞⩺ الامر دا للمسجلين ف البوت بس 🏌️⪀\n*┗━━━━━━━━━━━━━━━━⬣*\n\n> *ــ͓ؔ͢✵ اكـتـب ↜  ❲ ˼ .تسجيل ˹ ❳ لـلـتـسـجـيـل فـي الـبـوت يـا عـزيـزۍ 🧚🍷*`}[type]
  
  if (daftar) return conn.sendUrlImageButton(m.chat, daftar, [{name: "quick_reply", buttonParamsJson: `{"display_text": "❲ ˼ .تسجيل ˹ ❳", "id": ".تسجيل"}`}], wm, registrasi, fkon)
        }
