...
global.reloadHandler = async function(restatConn) {
    ...
    conn.welcome = '⛄┊≡ ◡̈⃝🍷↜مـرحـبـا يـا @user\n🌹┊≡ ◡̈⃝🎼↜الـمـجـمـوعـه\n🧚┊ ۬.͜ـ🧸˖ ⟨@subject☇\n╮─ׅ─๋︩︪─┈─๋︩︪─═⊐‹✨›⊏═┈ ─๋︩︪─ ∙ ∙ ⊰ـ\n┤─ׅ─ׅ┈ ─๋︩︪──ׅ─ׅ┈ ─๋︩︪─☇ـ\n┤┌\n│┊احـتـرام الاعـضـاء وعـدم الـسـب\n│┊يرجي عدم الدخول للبوت خاص\n│┊لـي الـقـائـمـه ｢.اوامـر｣\n│┊لـي الـمـطـور ｢.الـمـطـور｣\n│┊لـي ابـلاغ ｢.ابـلاغ｣\n┤└─ׅ─ׅ┈ ─๋︩︪──ׅ─ׅ┈ ─๋︩︪☇ـ\n╯─ׅ─๋︩︪─┈─๋︩︪─═⊐‹🍡›⊏═┈ ─๋︩︪⊐'
    conn.bye = '🌸┊≡ ◡̈⃝🍡↜مـع الـسـلامـه يـا @user'
