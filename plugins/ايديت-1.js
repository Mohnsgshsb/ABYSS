...
'https://telegra.ph/file/3aba3b86aced4c00e3b05.mp4',
    ...
    await conn.sendMessage(m.chat, {
        ...
        caption: '⧼🎞┊ ايـديـت انـمـي عـشـؤائـي ┊🎞⧽',
        buttons: [
            {
                buttonId: '.ايديت انمي',
                buttonText: {
